...
2. Place your raw fluorescence data in the project directory. The expected input format is a matrix where the first two columns are metadata (`Tissue`, `SampleID`), and the remaining columns are numerical features (genes/fluorescence signals).
